...
from tawrch import CenterCrop, Augment


# benchmark on a synthetic input
augment = Augment(seed=0)
...
# make a test batch
dataset = Flowers102("flowers", download=True, transform=PILToTensor())
...
augment = Augment(seed=0, mixup=0.5)
x, y = augment(x, y)
